<?php
$title = 'Dashboard Penjualan Onigiri';
$pageTitle = '🍙 Dashboard Penjualan Onigiri';
$pageSubtitle = 'Selamat datang, ' . $_SESSION['name'] . '!';
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div style="text-align:center; margin-top:0.5rem; color:var(--gray-400); font-size:0.85rem;">
...
<div style="display:flex; gap:1rem; flex-wrap:wrap; margin-bottom:1.5rem;">
    <a href="<?= BASE_URL ?>public/index.php?route=sales_create" class="btn-primary">🍙 Tambah Laporan Penjualan</a>
    <a href="<?= BASE_URL ?>public/index.php?route=visit" class="btn-secondary">📋 Laporan Visit</a>
</div>
            ...
            <?php foreach ($data['reports'] as $report): ?>
                <div class="report-card">
                    ...
                    <div class="report-body">
                        ...
                        <?php if ($report['photo'] !== 'default.jpg' && !empty($report['photo'])): ?>
                            <img src="<?= htmlspecialchars($report['photo']) ?>" alt="Foto" class="report-photo" onerror="this.style.display='none'">
                        <?php endif; ?>
